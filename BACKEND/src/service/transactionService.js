    ...
    try {
        ...
        if (txnType.toLowerCase() === 'buy') {
            ...
            if (currentBalance < totalAmount) {
                throw new Error(`Insufficient cash balance. Required: $${totalAmount.toFixed(2)}, Available: $${currentBalance.toFixed(2)}`);
            }
            ...
            if (currentHoldings < quantity) {
                throw new Error(`Insufficient holdings to sell. Required: ${quantity}, Available: ${currentHoldings}`);
            }
